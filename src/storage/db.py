...
class Database:
    ...
    def tracked_entity_repo(self) -> TrackedEntityRepository:
        from storage.repositories import TrackedEntityRepository
    ...
    def raw_event_repo(self) -> RawEventRepository:
        from storage.repositories import RawEventRepository
    ...
    def resolved_event_repo(self) -> ResolvedEventRepository:
        from storage.repositories import ResolvedEventRepository
    ...
    def alert_log_repo(self) -> AlertLogRepository:
        from storage.repositories import AlertLogRepository
    ...
    def bulk_deal_repo(self) -> "BulkDealRepository":
        from storage.repositories import BulkDealRepository
    ...
    def insider_trade_repo(self) -> "InsiderTradeRepository":
        from storage.repositories import InsiderTradeRepository
    ...
    def rating_change_repo(self) -> "RatingChangeRepository":
        from storage.repositories import RatingChangeRepository
    ...
    def sast_filing_repo(self) -> "SastFilingRepository":
        from storage.repositories import SastFilingRepository
    ...
    def llm_insight_repo(self) -> "LlmInsightRepository":
        from storage.repositories import LlmInsightRepository
    ...
    def scheduler_state_repo(self) -> "SchedulerStateRepository":
        from storage.repositories import SchedulerStateRepository
    ...
    def filing_document_repo(self) -> "FilingDocumentRepository":
        from storage.repositories import FilingDocumentRepository
        if "filing_document" not in self._repos:
            self._repos["filing_document"] = FilingDocumentRepository(self)
        return self._repos["filing_document"]
